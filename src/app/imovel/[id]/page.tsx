...
export default function ImovelPage() {
  ...
  useEffect(() => {
    ...
    const imagens = imovel.imagens && imovel.imagens.length > 0 ? imovel.imagens : [imovel.imagem]
  ...
  return (
    <div>
      ...
      <div className="max-w-[1100px] mx-auto mt-6 px-4">
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              ...
              {imovel.situacao === "construcao" ? (
                ...
                <div className="flex flex-col items-center text-center bg-gray-50 p-3 rounded-lg">
                  ...
                  <MapPinCheckInside />
                  <span>{imovel.situacao}</span>
                </div>
              )}

              <div className="flex flex-col items-center text-center justify-center bg-gray-50 p-3 rounded-lg">
                <MapPin />
        ...
        <a
          href={`https://wa.me/5583999883708?text=Tenho interesse no imóvel: ${imovel.titulo}`}
          target="_blank"
